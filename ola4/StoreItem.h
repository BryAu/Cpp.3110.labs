...
public:
	...
	StoreItem(std::string barcode = "", double price = 0, int copy = 0, int demand = 0, std::string title = "");
	...
	//Return m_author used in Book class
	//Movie class will inherit but won't use it
