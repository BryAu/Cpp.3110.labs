...
public:
	...
	//These functions print student records
	//printOneRecord takes a c-number as an argument and prints the record of that c-num
	//printStudentRecord prints all the records of the current object
	void printStudentRecord();
	void printOneRecord(std::string cnum);
